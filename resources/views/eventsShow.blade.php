<x-main-layout>
    <div class="m-2 p-2 flex justify-between">
        ...
        <div class="flex space-x-2  text-indigo-700 dark:text-gray-200">
            From:
    ...
    <div class="mb-16 flex flex-wrap">
        <div class="mb-6 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-6/12 lg:pr-6">
            <div class="flex flex-col">
                ...
                <div class="flex space-x-2 p-4" x-data="{
                    ...
                    <button type="button" @click="onHandleLike"
                        ...
                        :class="eventLike ? 'bg-green-700 hover:bg-green-800' : 'bg-slate-400 hover:bg-slate-500'">
            ...
            @endauth
                <div class="flex flex-col p-4">
                    ...
                    <div class="flex space-x-4 mt-6 bg-slate-200 dark:bg-slate-700 dark:text-white p-2 rounded-md">
                        <span>
        ...
        <div class="w-full shrink-0 grow-0 lg:w-6/12 lg:pl-6 bg-slate-50 dark:bg-slate-700 rounded-md p-2">
            ...
            <div class="flex justify-end">
                <div class="flex flex-col">
                    <div class="mb-4 flex items-center text-sm font-medium">
                        ...
                        <div class="text-yellow-700 dark:text-neutral-300">{{ $event->country->name }}, {{ $event->city->name }}</div>
                    </div>
                    <div class="text-yellow-700 dark:text-neutral-300">
                        {{ $event->address }}
                    </div>
                </div>
            </div>
